                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <div class="modal fade" id="dictamenModal{{ $alumno->codigo }}" tabindex="-1"
                                    role="dialog" aria-labelledby="modalTitle{{ $alumno->codigo }}" aria-hidden="true">
                            ...
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    ...
                                    <form method="POST" action="{{ route('/alumnos/asingnar/',$alumno->codigo) }}">
                                        {!! csrf_field() !!}
                                        {{ method_field('PUT') }}
                                        <div class="modal-body">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="egreso"
                                                    name="egreso" value="{{$alumno->calendarioTitulacion}}">
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="hidden" name="dictamen" id="dictamenHidden" value="{{$alumno->dictamen}}">
                                            </div>
